...
export const WEAPONS = {
  blade: { name: '파워 블레이드', icon: '⚔️', pair: 'guard', melee: true, evo: '대지 분쇄자', evoIcon: '🌋',
  ...
  rail: { name: '관통 레일건', icon: '🔫', pair: 'scope', comboWith: 'thunder', evo: '궤도 레일캐논', evoIcon: '🛰️',
  ...
  aura: { name: '열기 오라', icon: '♨️', pair: 'guard', melee: true, evo: '불사조의 가호', evoIcon: '🌞',
  ...
  trap: { name: '에테르 지뢰', icon: '🪤', pair: 'rune', evo: '지뢰밭 통제', evoIcon: '🕸️',
...
export const PASSIVES = {
  ...
  guard: { name: '결전 태세', icon: '🛡️', desc: '근접 무기 범위 +12%', apply: (s, l) => { s.meleeRangeMul *= 1 + 0.12 * l; } },
...
export const META = [
  ...
  { id: 'reroll', name: '재추첨', icon: '🎲', desc: '레벨업 다시 뽑기 +1회', max: 3, baseCost: 300, apply: () => { } },
];
